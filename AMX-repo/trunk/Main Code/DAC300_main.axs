...
(***********************************************************)
/* 29/May/2008
 *    Replacing NEC module with Realis module for dvProj.
 *     Non-TP system and has similarities to DAC100.
 *     Alot of garbage code, such as every reference to dvPROJ2
...
//Following projector is not in use in this room
...
//Changing to REALIS-SX7 (Same as AWKS112 and DAC100)
