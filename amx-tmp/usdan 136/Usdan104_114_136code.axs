...
{
    1, //DVD/VCR Combo Unit-DVD controls
    2,
    3, //VCR Combo Unit-VCR controls
    4, //PC
    5, //Table VGA
    6  //Table Video
} 
...
VOLATILE INTEGER combo_tp_controls[] = {61,67,66,65,68,62,60,63,69,72,71,70,73,1,3}
...
BUTTON_EVENT[dvTouchPanel,intSourceButton]// Sources
{
    PUSH:
    {
	  PULSE[vdvVSMod,intExtronSourceInputs[GET_LAST(intSourceButton)]]
	  intCurrentSource = intExtronSourceInputs[GET_LAST(intSourceButton)]
