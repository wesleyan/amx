MODULE_NAME='VideoSwitch_mod' (DEV dvreal, DEV vdvproxy)
(***********************************************************)
(* System Type : NetLinx                                   *)
(***********************************************************)
(* REV HISTORY:                                            *)
...
VOLATILE INTEGER error_feedback_channels[] =
{
...
DEFINE_CALL 'handle_errors'(char in1[4])
{
    SWITCH(in1)
    {
	CASE 'E01':  //invalid channel number
	{
	    pulse [vdvproxy,error_feedback_channels[1]]
	}
	CASE 'E02':  //slave communication error
	{
	    pulse [vdvproxy,error_feedback_channels[2]]
	}
	CASE 'E03':  //projector is powered off
	{
	    pulse [vdvproxy,error_feedback_channels[3]]
	}
	CASE 'E04':  //projector communication error
	{
	    pulse [vdvproxy,error_feedback_channels[4]]
	}
	CASE 'E06':  //VLB switch enabled & last input selected
	{
	    pulse [vdvproxy,error_feedback_channels[6]]
	}
	default:
	{
	    pulse [vdvproxy,error_feedback_channels[7]]
	}
    }
}
				...
				FOR(count=1; count <= MAX_LENGTH_ARRAY(SYS10_response) ; count++)
				{
					...
					{  //$$$$$$$$$$$$$$$ IF RECOGNIZED RESPONSE$$$$$$$$$$$$$$$$$$$$$$$$$$$$$//
						...
						{ //*****************ALTER EXTRON KEY VALUES*********************//        
							...
							CASE 'E':  //ERROR
							{
								send_string 0,"'I found an error: ',(s10Buff), '!!!!!!'"
								CALL 'handle_errors'(s10Buff)
							}
							CASE 'C':
							{
